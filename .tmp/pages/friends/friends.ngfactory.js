...
import * as import0 from './friends';
...
import * as import9 from '../../providers/friends-data';
...
import * as import45 from '../../node_modules/ionic-angular/components/avatar/avatar.ngfactory';
...
export var Wrapper_FriendsPage = (function () {
    function Wrapper_FriendsPage(p0, p1, p2) {
        this.changed = false;
        this.context = new import0.FriendsPage(p0, p1, p2);
    }
    Wrapper_FriendsPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
    ...
    return Wrapper_FriendsPage;
}());
var renderType_FriendsPage_Host = null;
var _View_FriendsPage_Host0 = (function (_super) {
    __extends(_View_FriendsPage_Host0, _super);
    function _View_FriendsPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_FriendsPage_Host0, renderType_FriendsPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_FriendsPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-friends', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_FriendsPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._FriendsPage_0_4 = new Wrapper_FriendsPage(this.parentInjector.get(import8.NavController), this.parentInjector.get(import9.FriendsData), this.parentInjector.get(import10.NgZone));
        this._appEl_0.initComponent(this._FriendsPage_0_4.context, [], compView_0);
        compView_0.create(this._FriendsPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_FriendsPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.FriendsPage) && (0 === requestNodeIndex))) {
            return this._FriendsPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_FriendsPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._FriendsPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_FriendsPage_Host0;
}(import1.AppView));
function viewFactory_FriendsPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_FriendsPage_Host === null)) {
        (renderType_FriendsPage_Host = viewUtils.createRenderComponentType('', 0, import11.ViewEncapsulation.None, [], {}));
    }
    return new _View_FriendsPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var FriendsPageNgFactory = new import12.ComponentFactory('page-friends', viewFactory_FriendsPage_Host0, import0.FriendsPage);
var styles_FriendsPage = [];
var renderType_FriendsPage = null;
var _View_FriendsPage0 = (function (_super) {
    __extends(_View_FriendsPage0, _super);
    function _View_FriendsPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_FriendsPage0, renderType_FriendsPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_FriendsPage0.prototype.createInternal = function (rootSelector) {
        var parentRenderNode = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
        this._el_0 = this.renderer.createElement(parentRenderNode, 'ion-header', null);
        this._Header_0_3 = new import13.Wrapper_Header(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_0), this.renderer, this.parentInjector.get(import26.ViewController, null));
        ...
        this._Navbar_2_4 = new import14.Wrapper_Navbar(this.parentInjector.get(import27.App), this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import8.NavController, null), this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_2), this.renderer);
        ...
        this._ToolbarTitle_4_4 = new import15.Wrapper_ToolbarTitle(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_4), this.renderer, this.parentInjector.get(import28.Toolbar, null), this._Navbar_2_4.context);
        this._appEl_4.initComponent(this._ToolbarTitle_4_4.context, [], compView_4);
        this._text_5 = this.renderer.createText(null, 'Friends', null);
        ...
        this._Button_7_4 = new import16.Wrapper_Button('', '', this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_7), this.renderer);
        this._MenuToggle_7_5 = new import17.Wrapper_MenuToggle(this.parentInjector.get(import29.MenuController), new import25.ElementRef(this._el_7), this.parentInjector.get(import26.ViewController, null), this._Navbar_2_4.context);
        this._ToolbarItem_7_6 = new import18.Wrapper_ToolbarItem(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_7), this.renderer, this.parentInjector.get(import28.Toolbar, null), this._Navbar_2_4.context);
        ...
        this._Icon_9_3 = new import20.Wrapper_Icon(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_9), this.renderer);
        ...
        this._Content_14_4 = new import21.Wrapper_Content(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_14), this.renderer, this.parentInjector.get(import27.App), this.parentInjector.get(import30.Keyboard), this.parentInjector.get(import10.NgZone), this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import31.Tabs, null));
        ...
        this._List_16_3 = new import22.Wrapper_List(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_16), this.renderer, this.parentInjector.get(import32.GestureController));
        ...
        this._TemplateRef_18_5 = new import33.TemplateRef_(this._appEl_18, viewFactory_FriendsPage1);
        this._NgFor_18_6 = new import23.Wrapper_NgFor(this._appEl_18.vcRef, this._TemplateRef_18_5, this.parentInjector.get(import34.IterableDiffers), this.ref);
    ...
    _View_FriendsPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import42.List) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._List_16_3.context;
        }
        if (((token === import43.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
            return this._Content_14_4.context;
        }
        return notFoundResult;
    };
    _View_FriendsPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_8 = this.context.friends;
    ...
    _View_FriendsPage0.prototype.destroyInternal = function () {
        this._Icon_9_3.context.ngOnDestroy();
        this._Content_14_4.context.ngOnDestroy();
    };
    _View_FriendsPage0.prototype._handle_click_7_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._MenuToggle_7_5.context.toggle() !== false);
        return (true && pd_0);
    };
    return _View_FriendsPage0;
}(import1.AppView));
export function viewFactory_FriendsPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_FriendsPage === null)) {
        (renderType_FriendsPage = viewUtils.createRenderComponentType('', 0, import11.ViewEncapsulation.None, styles_FriendsPage, {}));
    }
    return new _View_FriendsPage0(viewUtils, parentInjector, declarationEl);
}
var _View_FriendsPage1 = (function (_super) {
    __extends(_View_FriendsPage1, _super);
    function _View_FriendsPage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_FriendsPage1, renderType_FriendsPage, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_FriendsPage1.prototype.createInternal = function (rootSelector) {
        ...
        this._Item_0_4 = new import44.Wrapper_Item(this.parent.parentInjector.get(import46.Form), this.parent.parentInjector.get(import24.Config), new import25.ElementRef(this._el_0), this.renderer, this.parent.parentInjector.get(import47.ItemReorder, null));
        ...
        this._Avatar_2_3 = new import45.Wrapper_Avatar();
    ...
    _View_FriendsPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import48.Avatar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 5)))) {
            return this._Avatar_2_3.context;
        }
        if (((token === import49.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._Item_0_4.context;
        }
        if (((token === import49.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._ItemContent_0_5.context;
        }
        return notFoundResult;
    };
    _View_FriendsPage1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_1 = import4.interpolate(1, '', this.context.$implicit.image, '');
        if (import4.checkBinding(throwOnChange, this._expr_1, currVal_1)) {
            this.renderer.setElementProperty(this._el_4, 'src', this.viewUtils.sanitizer.sanitize(import50.SecurityContext.URL, currVal_1));
            this._expr_1 = currVal_1;
        }
        var currVal_2 = import4.interpolate(1, '', this.context.$implicit.username, '');
        if (import4.checkBinding(throwOnChange, this._expr_2, currVal_2)) {
            this.renderer.setText(this._text_8, currVal_2);
            this._expr_2 = currVal_2;
        }
        var currVal_3 = import4.interpolate(2, '', this.context.$implicit.name, ' ', this.context.$implicit.surname, '');
    ...
    _View_FriendsPage1.prototype._handle_click_0_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.parent.context.friendDetails(this.context.$implicit) !== false);
        return (true && pd_0);
    };
    return _View_FriendsPage1;
}(import1.AppView));
function viewFactory_FriendsPage1(viewUtils, parentInjector, declarationEl) {
    return new _View_FriendsPage1(viewUtils, parentInjector, declarationEl);
}
