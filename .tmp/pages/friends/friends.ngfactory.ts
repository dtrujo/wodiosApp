...
export class Wrapper_FriendsPage {
  context:import0.FriendsPage;
  changed:boolean;
...
var renderType_FriendsPage_Host:import2.RenderComponentType = (null as any);
class _View_FriendsPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _FriendsPage_0_4:Wrapper_FriendsPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_FriendsPage_Host0,renderType_FriendsPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-friends',rootSelector,(null as any));
    this._appEl_0 = new import3.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_FriendsPage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    this._appEl_0.initComponent(this._FriendsPage_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._FriendsPage_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.FriendsPage) && (0 === requestNodeIndex))) { return this._FriendsPage_0_4.context; }
...
function viewFactory_FriendsPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_FriendsPage_Host === (null as any))) { (renderType_FriendsPage_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_FriendsPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const FriendsPageNgFactory:import12.ComponentFactory<import0.FriendsPage> = new import12.ComponentFactory<import0.FriendsPage>('page-friends',viewFactory_FriendsPage_Host0,import0.FriendsPage);
const styles_FriendsPage:any[] = ([] as any[]);
var renderType_FriendsPage:import2.RenderComponentType = (null as any);
class _View_FriendsPage0 extends import1.AppView<import0.FriendsPage> {
  _el_0:any;
  ...
  _ToolbarItem_7_6:import18.Wrapper_ToolbarItem;
  _query_Button_7_0:import19.QueryList<any>;
  _text_8:any;
  _el_9:any;
  _Icon_9_3:import20.Wrapper_Icon;
  _text_10:any;
  _text_11:any;
  _text_12:any;
  _text_13:any;
  ...
  _NgFor_18_6:import23.Wrapper_NgFor;
  _text_19:any;
  _text_20:any;
  _text_21:any;
  /*private*/ _expr_0:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_FriendsPage0,renderType_FriendsPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._el_0 = this.renderer.createElement(parentRenderNode,'ion-header',(null as any));
    this._Header_0_3 = new import13.Wrapper_Header(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_0),this.renderer,this.parentInjector.get(import26.ViewController,(null as any)));
    ...
    this._Navbar_2_4 = new import14.Wrapper_Navbar(this.parentInjector.get(import27.App),this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_2),this.renderer);
    ...
    this._ToolbarTitle_4_4 = new import15.Wrapper_ToolbarTitle(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import28.Toolbar,(null as any)),this._Navbar_2_4.context);
    this._appEl_4.initComponent(this._ToolbarTitle_4_4.context,([] as any[]),compView_4);
    this._text_5 = this.renderer.createText((null as any),'Friends',(null as any));
    ...
    this._MenuToggle_7_5 = new import17.Wrapper_MenuToggle(this.parentInjector.get(import29.MenuController),new import25.ElementRef(this._el_7),this.parentInjector.get(import26.ViewController,(null as any)),this._Navbar_2_4.context);
    this._ToolbarItem_7_6 = new import18.Wrapper_ToolbarItem(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_7),this.renderer,this.parentInjector.get(import28.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    this._Content_14_4 = new import21.Wrapper_Content(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_14),this.renderer,this.parentInjector.get(import27.App),this.parentInjector.get(import30.Keyboard),this.parentInjector.get(import10.NgZone),this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import31.Tabs,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import36.Icon) && (9 === requestNodeIndex))) { return this._Icon_9_3.context; }
    if (((token === import37.Button) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._Button_7_4.context; }
    if (((token === import38.MenuToggle) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._MenuToggle_7_5.context; }
    if (((token === import39.ToolbarItem) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._ToolbarItem_7_6.context; }
    if (((token === import40.Navbar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Navbar_2_4.context; }
    ...
    if (((token === import42.List) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 19)))) { return this._List_16_3.context; }
    if (((token === import43.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._Content_14_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_8:any = this.context.friends;
...
export function viewFactory_FriendsPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.FriendsPage> {
  if ((renderType_FriendsPage === (null as any))) { (renderType_FriendsPage = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,styles_FriendsPage,{})); }
  return new _View_FriendsPage0(viewUtils,parentInjector,declarationEl);
}
class _View_FriendsPage1 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  ...
  _text_1:any;
  _el_2:any;
  _Avatar_2_3:import45.Wrapper_Avatar;
  _text_3:any;
  _el_4:any;
  _text_5:any;
  _text_6:any;
  ...
  /*private*/ _expr_3:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_FriendsPage1,renderType_FriendsPage,import6.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Item_0_4 = new import44.Wrapper_Item(this.parent.parentInjector.get(import46.Form),this.parent.parentInjector.get(import24.Config),new import25.ElementRef(this._el_0),this.renderer,this.parent.parentInjector.get(import47.ItemReorder,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import48.Avatar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 5)))) { return this._Avatar_2_3.context; }
    if (((token === import49.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._Item_0_4.context; }
    if (((token === import49.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._ItemContent_0_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_1:any = import4.interpolate(1,'',this.context.$implicit.image,'');
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this.renderer.setElementProperty(this._el_4,'src',this.viewUtils.sanitizer.sanitize(import50.SecurityContext.URL,currVal_1));
      this._expr_1 = currVal_1;
    }
    const currVal_2:any = import4.interpolate(1,'',this.context.$implicit.username,'');
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setText(this._text_8,currVal_2);
      this._expr_2 = currVal_2;
    }
    const currVal_3:any = import4.interpolate(2,'',this.context.$implicit.name,' ',this.context.$implicit.surname,'');
  ...
  private _handle_click_0_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.friendDetails(this.context.$implicit)) !== false);
    return (true && pd_0);
  }
}
function viewFactory_FriendsPage1(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
