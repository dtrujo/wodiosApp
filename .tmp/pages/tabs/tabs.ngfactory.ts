...
class _View_TabsPage0 extends import1.AppView<import0.TabsPage> {
  ...
  _Tab_8_4:import11.Wrapper_Tab;
  _text_9:any;
  _el_10:any;
  /*private*/ _appEl_10:import3.AppElement;
  _Tab_10_4:import11.Wrapper_Tab;
  _text_11:any;
  _text_12:any;
  /*private*/ _expr_2:any;
  /*private*/ _expr_3:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    var compView_8:any = import11.viewFactory_Tab0(this.viewUtils,this.injector(8),this._appEl_8);
    this._Tab_8_4 = new import11.Wrapper_Tab(this._Tabs_0_4.context,this.parentInjector.get(import14.App),this.parentInjector.get(import15.Config),this.parentInjector.get(import19.Keyboard),new import16.ElementRef(this._el_8),this.parentInjector.get(import20.NgZone),this.renderer,this.parentInjector.get(import21.ComponentFactoryResolver),compView_8.ref,this.parentInjector.get(import22.GestureController),this.parentInjector.get(import23.TransitionController),this.parentInjector.get(import18.DeepLinker,(null as any)));
    ...
    this._el_10 = this.renderer.createElement((null as any),'ion-tab',(null as any));
    ...
    var compView_10:any = import11.viewFactory_Tab0(this.viewUtils,this.injector(10),this._appEl_10);
    this._Tab_10_4 = new import11.Wrapper_Tab(this._Tabs_0_4.context,this.parentInjector.get(import14.App),this.parentInjector.get(import15.Config),this.parentInjector.get(import19.Keyboard),new import16.ElementRef(this._el_10),this.parentInjector.get(import20.NgZone),this.renderer,this.parentInjector.get(import21.ComponentFactoryResolver),compView_10.ref,this.parentInjector.get(import22.GestureController),this.parentInjector.get(import23.TransitionController),this.parentInjector.get(import18.DeepLinker,(null as any)));
    this._appEl_10.initComponent(this._Tab_10_4.context,([] as any[]),compView_10);
    compView_10.create(this._Tab_10_4.context,([] as any[]),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import24.Tab) && (8 === requestNodeIndex))) { return this._Tab_8_4.context; }
    if (((token === import24.Tab) && (10 === requestNodeIndex))) { return this._Tab_10_4.context; }
    if (((token === import25.Tabs) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Tabs_0_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_4:any = this.context.tab2Root;
    this._Tab_4_4.check_root(currVal_4,throwOnChange,false);
    const currVal_5:any = 'md-hand';
    ...
    const currVal_8:any = this.context.tab3Root;
    this._Tab_6_4.check_root(currVal_8,throwOnChange,false);
    const currVal_9:any = 'md-people';
    ...
    const currVal_12:any = this.context.tab4Root;
    this._Tab_8_4.check_root(currVal_12,throwOnChange,false);
    const currVal_13:any = 'md-trophy';
    ...
    const currVal_16:any = this.context.tab5Root;
    this._Tab_10_4.check_root(currVal_16,throwOnChange,false);
    const currVal_17:any = 'md-book';
    ...
    const currVal_6:any = this._Tab_4_4.context._tabId;
    if (import4.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this.renderer.setElementAttribute(this._el_4,'id',((currVal_6 == (null as any))? (null as any): currVal_6.toString()));
      this._expr_6 = currVal_6;
    }
    const currVal_7:any = this._Tab_4_4.context._btnId;
    if (import4.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      this.renderer.setElementAttribute(this._el_4,'aria-labelledby',((currVal_7 == (null as any))? (null as any): currVal_7.toString()));
      this._expr_7 = currVal_7;
    }
    const currVal_10:any = this._Tab_6_4.context._tabId;
    if (import4.checkBinding(throwOnChange,this._expr_10,currVal_10)) {
      this.renderer.setElementAttribute(this._el_6,'id',((currVal_10 == (null as any))? (null as any): currVal_10.toString()));
      this._expr_10 = currVal_10;
    }
    const currVal_11:any = this._Tab_6_4.context._btnId;
    if (import4.checkBinding(throwOnChange,this._expr_11,currVal_11)) {
      this.renderer.setElementAttribute(this._el_6,'aria-labelledby',((currVal_11 == (null as any))? (null as any): currVal_11.toString()));
      this._expr_11 = currVal_11;
    }
    const currVal_14:any = this._Tab_8_4.context._tabId;
    if (import4.checkBinding(throwOnChange,this._expr_14,currVal_14)) {
      this.renderer.setElementAttribute(this._el_8,'id',((currVal_14 == (null as any))? (null as any): currVal_14.toString()));
      this._expr_14 = currVal_14;
    }
    const currVal_15:any = this._Tab_8_4.context._btnId;
    if (import4.checkBinding(throwOnChange,this._expr_15,currVal_15)) {
      this.renderer.setElementAttribute(this._el_8,'aria-labelledby',((currVal_15 == (null as any))? (null as any): currVal_15.toString()));
      this._expr_15 = currVal_15;
    }
    const currVal_18:any = this._Tab_10_4.context._tabId;
    if (import4.checkBinding(throwOnChange,this._expr_18,currVal_18)) {
      this.renderer.setElementAttribute(this._el_10,'id',((currVal_18 == (null as any))? (null as any): currVal_18.toString()));
      this._expr_18 = currVal_18;
    }
    const currVal_19:any = this._Tab_10_4.context._btnId;
    if (import4.checkBinding(throwOnChange,this._expr_19,currVal_19)) {
      this.renderer.setElementAttribute(this._el_10,'aria-labelledby',((currVal_19 == (null as any))? (null as any): currVal_19.toString()));
