...
export const AboutPageNgFactory:import10.ComponentFactory<import0.AboutPage> = new import10.ComponentFactory<import0.AboutPage>('ng-component',viewFactory_AboutPage_Host0,import0.AboutPage);
...
class _View_AboutPage0 extends import1.AppView<import0.AboutPage> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._text_5 = this.renderer.createText((null as any),'About',(null as any));
    ...
    this._Button_7_4 = new import14.Wrapper_Button('','',this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_7),this.renderer);
    this._MenuToggle_7_5 = new import15.Wrapper_MenuToggle(this.parentInjector.get(import25.MenuController),new import21.ElementRef(this._el_7),this.parentInjector.get(import22.ViewController,(null as any)),this._Navbar_2_4.context);
    this._ToolbarItem_7_6 = new import16.Wrapper_ToolbarItem(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_7),this.renderer,this.parentInjector.get(import24.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    this._Icon_9_3 = new import18.Wrapper_Icon(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_9),this.renderer);
    ...
    this.renderer.setElementAttribute(this._el_14,'class','about');
    ...
    this._Content_14_4 = new import19.Wrapper_Content(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_14),this.renderer,this.parentInjector.get(import23.App),this.parentInjector.get(import26.Keyboard),this.parentInjector.get(import27.NgZone),this.parentInjector.get(import22.ViewController,(null as any)),this.parentInjector.get(import28.Tabs,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import34.Navbar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Navbar_2_4.context; }
    if (((token === import24.Header) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._Header_0_3.context; }
    if (((token === import35.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Content_14_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
