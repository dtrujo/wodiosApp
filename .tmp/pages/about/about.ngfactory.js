...
export var AboutPageNgFactory = new import10.ComponentFactory('ng-component', viewFactory_AboutPage_Host0, import0.AboutPage);
...
var _View_AboutPage0 = (function (_super) {
    ...
    _View_AboutPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._ToolbarTitle_4_4 = new import13.Wrapper_ToolbarTitle(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_4), this.renderer, this.parentInjector.get(import24.Toolbar, null), this._Navbar_2_4.context);
        this._appEl_4.initComponent(this._ToolbarTitle_4_4.context, [], compView_4);
        this._text_5 = this.renderer.createText(null, 'About', null);
        ...
        this._MenuToggle_7_5 = new import15.Wrapper_MenuToggle(this.parentInjector.get(import25.MenuController), new import21.ElementRef(this._el_7), this.parentInjector.get(import22.ViewController, null), this._Navbar_2_4.context);
        this._ToolbarItem_7_6 = new import16.Wrapper_ToolbarItem(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_7), this.renderer, this.parentInjector.get(import24.Toolbar, null), this._Navbar_2_4.context);
    ...
    _View_AboutPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import35.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
    ...
    _View_AboutPage0.prototype._handle_click_7_0 = function ($event) {
