...
export const ResetPasswordPageNgFactory:import14.ComponentFactory<import0.ResetPasswordPage> = new import14.ComponentFactory<import0.ResetPasswordPage>('ng-component',viewFactory_ResetPasswordPage_Host0,import0.ResetPasswordPage);
...
class _View_ResetPasswordPage0 extends import1.AppView<import0.ResetPasswordPage> {
  ...
  _Button_22_4:import26.Wrapper_Button;
  _text_23:any;
  _text_24:any;
  _text_25:any;
  _text_26:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._text_6 = this.renderer.createText((null as any),'resetpassword',(null as any));
    ...
    this._el_22 = this.renderer.createElement(this._el_12,'button',(null as any));
    ...
    this._Button_22_4 = new import26.Wrapper_Button((null as any),'',this.parentInjector.get(import27.Config),new import28.ElementRef(this._el_22),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import46.Button) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._Button_22_4.context; }
    if (((token === import47.FormGroupDirective) && ((12 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._FormGroupDirective_12_3.context; }
    if (((token === import48.ControlContainer) && ((12 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._ControlContainer_12_4; }
    if (((token === import43.NgControlStatusGroup) && ((12 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._NgControlStatusGroup_12_5.context; }
    if (((token === import49.Content) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._Content_10_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_6:any = this.context.resetPasswordForm;
