...
export const HomePageNgFactory:import13.ComponentFactory<import0.HomePage> = new import13.ComponentFactory<import0.HomePage>('ng-component',viewFactory_HomePage_Host0,import0.HomePage);
...
class _View_HomePage0 extends import1.AppView<import0.HomePage> {
  ...
  _Button_7_4:import17.Wrapper_Button;
  _MenuToggle_7_5:import18.Wrapper_MenuToggle;
  _ToolbarItem_7_6:import19.Wrapper_ToolbarItem;
  _query_Button_7_0:import20.QueryList<any>;
  _text_8:any;
  _el_9:any;
  _Icon_9_3:import21.Wrapper_Icon;
  _text_10:any;
  _text_11:any;
  _el_12:any;
  _ToolbarItem_12_3:import19.Wrapper_ToolbarItem;
  _query_Button_12_0:import20.QueryList<any>;
  _text_13:any;
  _el_14:any;
  /*private*/ _appEl_14:import3.AppElement;
  _Button_14_4:import17.Wrapper_Button;
  _el_15:any;
  ...
  _Content_20_4:import22.Wrapper_Content;
  _text_21:any;
  _el_22:any;
  _text_23:any;
  _text_24:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    var compView_7:any = import17.viewFactory_Button0(this.viewUtils,this.injector(7),this._appEl_7);
    ...
    this._MenuToggle_7_5 = new import18.Wrapper_MenuToggle(this.parentInjector.get(import28.MenuController),new import24.ElementRef(this._el_7),this.parentInjector.get(import25.ViewController,(null as any)),this._Navbar_2_4.context);
    this._ToolbarItem_7_6 = new import19.Wrapper_ToolbarItem(this.parentInjector.get(import23.Config),new import24.ElementRef(this._el_7),this.renderer,this.parentInjector.get(import27.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    this._ToolbarItem_12_3 = new import19.Wrapper_ToolbarItem(this.parentInjector.get(import23.Config),new import24.ElementRef(this._el_12),this.renderer,this.parentInjector.get(import27.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    var compView_14:any = import17.viewFactory_Button0(this.viewUtils,this.injector(14),this._appEl_14);
    this._Button_14_4 = new import17.Wrapper_Button((null as any),'',this.parentInjector.get(import23.Config),new import24.ElementRef(this._el_14),this.renderer);
    ...
    compView_14.create(this._Button_14_4.context,[([] as any[]).concat([this._el_15])],(null as any));
    ...
    var compView_20:any = import22.viewFactory_Content0(this.viewUtils,this.injector(20),this._appEl_20);
    ...
    this._text_23 = this.renderer.createText(this._el_22,'Welcome to Ionic!',(null as any));
    ...
    this._el_30 = this.renderer.createElement(this._el_28,'code',(null as any));
    this._text_31 = this.renderer.createText(this._el_30,'app/',(null as any));
    ...
    this._el_34 = this.renderer.createElement((null as any),'h2',(null as any));
    this._text_35 = this.renderer.createText(this._el_34,'User data',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import32.Icon) && (9 === requestNodeIndex))) { return this._Icon_9_3.context; }
    if (((token === import33.Button) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._Button_7_4.context; }
    if (((token === import34.MenuToggle) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._MenuToggle_7_5.context; }
    if (((token === import35.ToolbarItem) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._ToolbarItem_7_6.context; }
    if (((token === import32.Icon) && (15 === requestNodeIndex))) { return this._Icon_15_3.context; }
    if (((token === import33.Button) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Button_14_4.context; }
    if (((token === import35.ToolbarItem) && ((12 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._ToolbarItem_12_3.context; }
    if (((token === import36.Navbar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Navbar_2_4.context; }
    if (((token === import27.Header) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Header_0_3.context; }
    if (((token === import37.Content) && ((20 <= requestNodeIndex) && (requestNodeIndex <= 41)))) { return this._Content_20_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_10:any = this._Content_20_4.context._sbPadding;
    ...
    const currVal_12:any = import4.interpolate(1,'',this.context.currentUser.image,'');
