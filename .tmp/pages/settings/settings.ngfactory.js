...
import * as import0 from './settings';
...
export var Wrapper_SettingsPage = (function () {
    function Wrapper_SettingsPage(p0) {
        this.changed = false;
        this.context = new import0.SettingsPage(p0);
    }
    Wrapper_SettingsPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_SettingsPage;
}());
var renderType_SettingsPage_Host = null;
var _View_SettingsPage_Host0 = (function (_super) {
    __extends(_View_SettingsPage_Host0, _super);
    function _View_SettingsPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SettingsPage_Host0, renderType_SettingsPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SettingsPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('ng-component', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_SettingsPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._SettingsPage_0_4 = new Wrapper_SettingsPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._SettingsPage_0_4.context, [], compView_0);
        compView_0.create(this._SettingsPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_SettingsPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.SettingsPage) && (0 === requestNodeIndex))) {
            return this._SettingsPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_SettingsPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._SettingsPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_SettingsPage_Host0;
}(import1.AppView));
function viewFactory_SettingsPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SettingsPage_Host === null)) {
        (renderType_SettingsPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_SettingsPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var SettingsPageNgFactory = new import10.ComponentFactory('ng-component', viewFactory_SettingsPage_Host0, import0.SettingsPage);
var styles_SettingsPage = [];
var renderType_SettingsPage = null;
var _View_SettingsPage0 = (function (_super) {
    __extends(_View_SettingsPage0, _super);
    function _View_SettingsPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SettingsPage0, renderType_SettingsPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SettingsPage0.prototype.createInternal = function (rootSelector) {
    ...
    _View_SettingsPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_SettingsPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_SettingsPage0.prototype.destroyInternal = function () {
        this._Content_10_4.context.ngOnDestroy();
    };
    return _View_SettingsPage0;
}(import1.AppView));
export function viewFactory_SettingsPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SettingsPage === null)) {
        (renderType_SettingsPage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_SettingsPage, {}));
    }
    return new _View_SettingsPage0(viewUtils, parentInjector, declarationEl);
}
