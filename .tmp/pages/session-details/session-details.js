...
export var SessionDetailsPage = (function () {
    /**
    */
    function SessionDetailsPage(navCtrl) {
    ...
    /**
    */
    SessionDetailsPage.prototype.ionViewDidLoad = function () {
        console.log('Hello SessionDetailsPage Page');
    };
    SessionDetailsPage.decorators = [
        { type: Component, args: [{
