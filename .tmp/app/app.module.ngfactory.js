...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_29", {
        get: function () {
            if ((this.__APP_ID_29 == null)) {
                (this.__APP_ID_29 = import80._appIdRandomProviderFactory());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_33", {
        get: function () {
            if ((this.__EventManager_33 == null)) {
                (this.__EventManager_33 = new import17.EventManager(this._EVENT_MANAGER_PLUGINS_32, this.parent.get(import84.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_37", {
        get: function () {
            if ((this.__RootRenderer_37 == null)) {
                (this.__RootRenderer_37 = import85._createConditionalRootRenderer(this._DomRootRenderer_36, this.parent.get(import85.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AppRootToken_53", {
        get: function () {
            if ((this.__AppRootToken_53 == null)) {
                (this.__AppRootToken_53 = import86.MyApp);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Keyboard_61", {
        get: function () {
            if ((this.__Keyboard_61 == null)) {
                (this.__Keyboard_61 = new import35.Keyboard(this._Config_21, this._Form_58, this.parent.get(import84.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_63", {
        get: function () {
            if ((this.__LocationStrategy_63 == null)) {
                (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import87.PlatformLocation), this.parent.get(import88.APP_BASE_HREF, null), this._Config_21));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TapClick_69", {
        get: function () {
            if ((this.__TapClick_69 == null)) {
                (this.__TapClick_69 = new import42.TapClick(this._Config_21, this._App_22, this.parent.get(import84.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_UrlSerializer_72", {
        get: function () {
            if ((this.__UrlSerializer_72 == null)) {
                (this.__UrlSerializer_72 = import89.setupUrlSerializer(this._DeepLinkConfigToken_54));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_DeepLinker_73", {
        get: function () {
            if ((this.__DeepLinker_73 == null)) {
                (this.__DeepLinker_73 = import90.setupDeepLinker(this._App_22, this._UrlSerializer_72, this._Location_64));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_StorageData_74", {
        get: function () {
            if ((this.__StorageData_74 == null)) {
                (this.__StorageData_74 = new import45.StorageData(this._Http_50));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AuthData_75", {
        get: function () {
            if ((this.__AuthData_75 == null)) {
                (this.__AuthData_75 = new import46.AuthData(this._Http_50, this.parent.get(import84.NgZone), this._StorageData_74));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TrainingData_76", {
        get: function () {
            if ((this.__TrainingData_76 == null)) {
                (this.__TrainingData_76 = new import47.TrainingData(this._Http_50));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ExerciseData_77", {
        get: function () {
            if ((this.__ExerciseData_77 == null)) {
                (this.__ExerciseData_77 = new import48.ExerciseData(this._Http_50));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_FriendsData_78", {
        get: function () {
            if ((this.__FriendsData_78 == null)) {
                (this.__FriendsData_78 = new import49.FriendsData(this._Http_50, this.parent.get(import84.NgZone), this._AuthData_75));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ApplicationRef__26 = new import14.ApplicationRef_(this.parent.get(import84.NgZone), this.parent.get(import97.Console), this, this._ErrorHandler_11, this, this._ApplicationInitStatus_24, this.parent.get(import13.TestabilityRegistry, null), this._Testability_25);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import94.ConfigToken)) {
            return this._ConfigToken_12;
        }
        if ((token === import91.UrlToken)) {
            return this._UrlToken_13;
        }
        if ((token === import91.QueryParams)) {
            return this._QueryParams_14;
        }
        if ((token === import92.PlatformConfigToken)) {
            return this._PlatformConfigToken_15;
        }
        if ((token === import93.UserAgentToken)) {
            return this._UserAgentToken_16;
        }
        if ((token === import93.NavigatorPlatformToken)) {
            return this._NavigatorPlatformToken_17;
        }
        if ((token === import93.DocumentDirToken)) {
            return this._DocumentDirToken_18;
        }
        if ((token === import93.DocLangToken)) {
            return this._DocLangToken_19;
        }
        if ((token === import93.Platform)) {
            return this._Platform_20;
        }
        if ((token === import94.Config)) {
        ...
        if ((token === import108.AppRootToken)) {
            return this._AppRootToken_53;
        }
        if ((token === import89.DeepLinkConfigToken)) {
        ...
        if ((token === import88.LocationStrategy)) {
        ...
        if ((token === import89.UrlSerializer)) {
            return this._UrlSerializer_72;
        }
        if ((token === import90.DeepLinker)) {
            return this._DeepLinker_73;
        }
        if ((token === import45.StorageData)) {
            return this._StorageData_74;
        }
        if ((token === import46.AuthData)) {
            return this._AuthData_75;
        }
        if ((token === import47.TrainingData)) {
            return this._TrainingData_76;
        }
        if ((token === import48.ExerciseData)) {
            return this._ExerciseData_77;
        }
        if ((token === import49.FriendsData)) {
            return this._FriendsData_78;
        }
