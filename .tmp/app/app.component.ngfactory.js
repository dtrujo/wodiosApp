...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import15.viewFactory_Toolbar0(this.viewUtils, this.injector(2), this._appEl_2);
        this._Toolbar_2_4 = new import15.Wrapper_Toolbar(this.parentInjector.get(import25.ViewController, null), this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_2), this.renderer);
        ...
        this._ToolbarTitle_4_4 = new import16.Wrapper_ToolbarTitle(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_4), this.renderer, this._Toolbar_2_4.context, this.parentInjector.get(import26.Navbar, null));
        this._appEl_4.initComponent(this._ToolbarTitle_4_4.context, [], compView_4);
        this._text_5 = this.renderer.createText(null, 'Menu', null);
        ...
        var compView_8 = import17.viewFactory_Content0(this.viewUtils, this.injector(8), this._appEl_8);
        ...
        this._el_17 = this.renderer.createElement(parentRenderNode, 'ion-nav', null);
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import36.Toolbar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
            return this._Toolbar_2_4.context;
        }
        if (((token === import29.TemplateRef) && (12 === requestNodeIndex))) {
            return this._TemplateRef_12_5;
        }
        if (((token === import37.NgFor) && (12 === requestNodeIndex))) {
            return this._NgFor_12_6.context;
        }
        if (((token === import38.List) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
            return this._List_10_3.context;
        }
        if (((token === import39.Content) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Content_8_4.context;
        }
        if (((token === import40.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Menu_0_4.context;
        }
        if (((token === import41.Nav) && (17 === requestNodeIndex))) {
            return this._Nav_17_4.context;
        }
        return notFoundResult;
    };
    _View_MyApp0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0 = this._Nav_17_4.context;
        ...
        var currVal_2 = this._Content_8_4.context._sbPadding;
        ...
        if (!throwOnChange) {
            if ((this.numberOfChecks === 0)) {
                this._Nav_17_4.context.ngAfterViewInit();
            }
        }
    };
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.createInternal = function (rootSelector) {
        ...
        this._Item_0_4 = new import42.Wrapper_Item(this.parent.parentInjector.get(import43.Form), this.parent.parentInjector.get(import22.Config), new import21.ElementRef(this._el_0), this.renderer, this.parent.parentInjector.get(import44.ItemReorder, null));
    ...
    _View_MyApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import45.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._Item_0_4.context;
        }
        if (((token === import45.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
